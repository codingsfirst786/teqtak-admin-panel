...
import MonthlyEnterpreneurUser from '../UserProfile/EnterpreneurUser/MonthlyEnterpreneurUser';
...
const MonthlyEnterpreneur = () => {
  ...
  if (selectedUser) {
    return <MonthlyEnterpreneurUser user={selectedUser} onBack={handleBackClick} />;
  }
