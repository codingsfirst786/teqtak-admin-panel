...
import WeeklyEnterpreneurUser from '../UserProfile/EnterpreneurUser/WeeklyEnterpreneurUser';
...
const WeeklyEnterpreneur = () => {
  ...
  if (selectedUser) {
    return <WeeklyEnterpreneurUser user={selectedUser} onBack={handleBackClick} />;
  }
